...
function TableHead({ className, ...props }) {
  return (
    <th
      ...
      className={cn(
        'text-foreground text-neutral-content h-10 px-2 text-center align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
